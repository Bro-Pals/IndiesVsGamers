 ...
 * @author Kevin
 */
public class KnightDownEntity extends SwordEntity {

    private boolean waiting, charging;
    private int waitingTimer, chargingTimer;
    
    public KnightDownEntity(SwordEntityComponent body, 
    ...
    public void update(int i) {
        ...
        // shimmy until you are above the player
        // walk in place a teeny bit
        // charge straight down and don't stop (can't stop)
        // after colliding with something or moving a certain distance stop and repeat
        
        float diffY = player.getCenterY() - getCenterY();
        float diffX = player.getCenterX() - getCenterX();
        
        boolean abovePlayer = diffY > 100;
